...
namespace com.esendex.sdk.test.optouts.getall
{
    ...
    public class OptOutsServiceGetAllWithFromAndAccountReferenceTests
    {
        ...
        {
            var expectedUrl = string.Format("/v1.0/optouts?startIndex={0}&count={1}&accountreference={2}&from={3}", (_pageNumber - 1) * _pageSize, _pageSize, _accountReference, _phoneNumber);
        ...
        public void ThenTheExpectedResultIsReturned()
        {
            ...
            Assert.That(optOut.From.PhoneNumber, Is.EqualTo(_phoneNumber));
